<template>
  <div class="app-container">
    ...
    <el-table border :data="userList" v-loading="loading">
      ...
      <!--    邮箱    -->
      <el-table-column prop="email" label="邮箱" align="center" width="140"></el-table-column>
      <!--   地址     -->
      <el-table-column prop="address" label="地址" align="center" width="140"></el-table-column>
      <!-- 登录方式 -->
