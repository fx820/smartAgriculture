...
import static cn.ecnu.constant.RedisConstant.CODE_KEY;
import static cn.ecnu.utils.PageUtils.getLimit;
import static cn.ecnu.utils.PageUtils.getSize;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public UserInfoVO getUserInfo() {
        Integer userId = StpUtil.getLoginIdAsInt();
        User user = userMapper.selectOne(new LambdaQueryWrapper<User>()
                .select(User::getNickName, User::getAvatar, User::getUserName, User::getEmail, User::getLoginType)
