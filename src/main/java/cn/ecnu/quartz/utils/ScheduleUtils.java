package cn.ecnu.quartz.utils;

import cn.ecnu.quartz.execution.QuartzJobExecution;
import cn.ecnu.constant.ScheduleConstant;
import cn.ecnu.entity.Task;
import cn.ecnu.enums.TaskStatusEnum;
import cn.ecnu.exception.ServiceException;
import cn.ecnu.quartz.execution.QuartzDisallowConcurrentExecution;
import org.quartz.*;

import static cn.ecnu.constant.CommonConstant.TRUE;
